...
export function HeroSection({ title, description, buttonText, onButtonClick }: HeroSectionProps) {
  return (
    <section className="flex flex-col md:flex-row justify-between items-center bg-blue-50 py-20 px-4 md:px-8 lg:px-16 gap-10 min-h-[450px]">
      <div className="flex-1 max-w-xl text-center md:text-left">
        ...
        <button
          ...
          className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1"
        >
          {buttonText}
        </button>
      </div>
      ...
      <div className="flex-1 flex justify-center items-center relative w-full md:w-auto">
        <div className="relative w-48 h-48 md:w-64 md:h-64 bg-blue-200 rounded-full flex justify-center items-center shadow-xl">
          ...
          <img src="https://via.placeholder.com/30/60A5FA/FFFFFF?text=P1" alt="Person 1" className="absolute top-8 left-8 rounded-full shadow-md" />
          <img src="https://via.placeholder.com/30/60A5FA/FFFFFF?text=P2" alt="Person 2" className="absolute bottom-8 right-8 rounded-full shadow-md" />
          <img src="https://via.placeholder.com/40x30/60A5FA/FFFFFF?text=PC" alt="Computer" className="absolute bottom-10 left-16 rounded-md shadow-md" />
        </div>
      </div>
    </section>
  );
